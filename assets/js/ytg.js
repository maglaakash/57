...
function setDisplay (value) {
    ...
    function isMaxResAvailable (result) {
        ...
        img.onload = function () {
            if (this.width < 1280) {
                ...
                document.getElementById("hdrestext").textContent = "Full HD Thumbnail (1280x720)";
            }
        }
    ...
    function isSDAvailalbe (result) {
        ...
        img.onload = function () {
            if (this.width === 120 && this.height === 90) {
                ...
                document.getElementById("sdrestext").textContent = "SD Thumbnail (640x480)";
            }
        }
        img.onerror = function () {
            document.getElementById("sdrestext").textContent = "Standard Quality not available";
    ...
    function appendImages (result) {
        ...
        document.getElementById("sdrestext").textContent = "SD Thumbnail (640x480)";
        document.getElementById("normalrestext").textContent = "Normal Thumbnail (480x360)";
